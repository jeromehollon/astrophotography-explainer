...
import { TopBar, BottomNav, Toggle, ROITile, Callout, Eyebrow } from './chrome';
...
export default function DarksPage() {
  ...
  return (
    <div className="flex w-[1440px] flex-col bg-surface-page">
      <TopBar chapter="Calibration" page="Darks" />
      <main className="flex w-full flex-col items-start gap-[32px] px-[120px] py-[64px]">
        <div className="flex flex-col gap-[12px]">
          <Eyebrow>Chapter 4 · Calibration</Eyebrow>
          <h1 className="w-[900px] font-heading text-[40px] leading-[46px] font-semibold tracking-[-0.5px] text-text-primary">What the camera records in the dark</h1>
          <div className="w-[900px] font-body text-[18px] leading-[28px] text-text-secondary">
        ...
        <section className="flex items-start gap-[24px]">
          <div className="flex w-[800px] flex-col gap-[16px] rounded-md border border-border-default bg-surface-card p-[24px]">
            ...
            <div className="flex flex-col gap-[24px] font-body text-[16px] leading-[24px] text-text-primary">
              <p className="w-[752px]">
          ...
          <div className="flex flex-col gap-[12px]">
            ...
            <p className="w-[376px] font-body text-[14px] leading-[20px] font-medium text-text-primary">The dark recorded by the camera</p>
            <p className="w-[376px] font-body text-[14px] leading-[20px] text-text-secondary">
        ...
        <section className="flex items-start gap-[48px]">
          <div className="flex flex-col gap-[24px]">
            ...
            <div className="flex flex-col gap-[24px] text-text-primary">
              <h2 className="w-[440px] font-heading text-[28px] leading-[34px] font-semibold">The problem you can see</h2>
              <p className="w-[440px] font-body text-[16px] leading-[24px]">
          ...
          <div className="flex flex-col gap-[12px]">
            ...
            <p className="w-[712px] font-body text-[14px] leading-[20px] font-medium text-text-primary">Amplifier glow on an older camera</p>
            <p className="w-[712px] font-body text-[14px] leading-[20px] text-text-secondary">
        ...
        <section className="flex items-start gap-[48px]">
          <div className="flex flex-col gap-[24px] text-text-primary">
            <h2 className="w-[680px] font-heading text-[28px] leading-[34px] font-semibold">Matching the dark to the light</h2>
          ...
          <Callout title="Why some grain remains">
      ...
      <section className="flex w-full flex-col items-start gap-[40px] bg-surface-stage px-[120px] py-[48px]">
        <div className="flex flex-col gap-[12px]">
          ...
          <h2 className="w-[900px] font-heading text-[28px] leading-[34px] font-semibold text-text-on-stage">Subtract the dark</h2>
        ...
        <div className="flex flex-col gap-[16px]">
          <div className="flex items-center gap-[24px]">
            <h3 className="font-heading text-[22px] leading-[28px] font-medium whitespace-nowrap text-text-on-stage">Subtracting the dark</h3>
      ...
      <BottomNav prev={{ label: 'Bias', path: '/calibration/bias' }} next={{ label: 'Flats', path: '/calibration/flats' }} />
    </div>
  );
}
